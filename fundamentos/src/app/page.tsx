...
export default function Home() {
  return (
    <div style={{
      ...
      <Navegador texto="Componente com Estado" destino="/estado" cor="orange"></Navegador>
      <Navegador texto="Inmtegração com API #01" destino="/integracao_1" cor="yellow"></Navegador>
    </div>
  )
}
